...
|---|---------|--------|-------|
| 1.1 | **`index` command** — walk a source tree, parse Java files with JavaParser, persist method-call edges to SQLite | `[ ]` | Use `LanguageLevel.JAVA_8` for legacy project compatibility |
...
|----|-------------|---------|----------|
| — | *(ledger empty — will be populated as shortcuts are taken)* | — | — |
